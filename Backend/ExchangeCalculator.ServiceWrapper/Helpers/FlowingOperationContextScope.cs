...
{
    /// <summary>
    /// Found this class written by Sergei on GitHub. 
    /// It solves the problem with OperationContextScope being thread specific and not possible to use asynchronous.
    /// https://github.com/belsoft/traingraph/blob/master/src/TrainGraph.WebA/Helpers/FlowingOperationContextScope.cs
    /// </summary>
